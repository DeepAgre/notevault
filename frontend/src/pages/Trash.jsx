...
function Trash() {
  ...
  const deleteAllTrash = async () => {
    try {
      // Loop through all trash notes and permanently delete them
    ...
    <div className="min-h-screen bg-[#FFFDF8] text-[#292726]">
      ...
      <div className="relative flex min-h-screen">
        ...
        <main className="min-w-0 flex-1 px-5 pb-12 pt-5 md:px-10 md:py-8 xl:px-14">
          ...
          <AnimatePresence>
            {showMobileMenu && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -8 }}
                className="mb-6 overflow-hidden rounded-3xl border border-[#E9E5DD] bg-white p-2 shadow-lg md:hidden"
              >
                <button
          ...
          {/* Header without red banner */}
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-4xl font-bold tracking-tight text-[#302D2A] md:text-5xl">
                Trash
              </h1>
              <p className="mt-2 text-sm leading-6 text-[#77716B]">
                Reflections you have tucked away. Restore them anytime or permanently clear them.
              </p>
            </div>
            ...
            {trashNotes.length > 0 && (
              <button
                ...
                className="flex cursor-pointer items-center gap-2 rounded-2xl bg-[#FFF0F2] border border-[#F3C9CE] px-5 py-3 text-sm font-semibold text-[#B85D69] transition hover:bg-[#FFE5E8]"
              >
                <Trash2 size={17} />
          ...
          <div className="mt-10">
            ...
            {trashNotes.length === 0 ? (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="flex min-h-[360px] flex-col items-center justify-center rounded-[32px] border border-dashed border-[#DDD7CD] bg-white px-6 text-center"
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#FFF0F2] text-2xl text-[#B85D69]">
                  🗑️
                </div>

                <h2 className="mt-6 text-xl font-semibold text-[#302D2A]">
                  Trash is empty
                </h2>

                <p className="mt-2 max-w-sm text-sm leading-relaxed text-[#77716B]">
                  Deleted reflections will appear here. You can restore them whenever you are ready.
                </p>
              </motion.div>
            ) : (
              <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
                {trashNotes.map((note, index) => (
                  <motion.div
                    ...
                    className={`group relative flex min-h-[280px] flex-col overflow-hidden rounded-[28px] p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
                      [
                      ...
                      <div className="border-t border-[#EEEAE3] pt-5">
                        ...
                        <div className="mt-4 flex gap-2">
                          <button
                            ...
                            className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border border-[#BFECEF] bg-[#ECFAFB] px-3 py-2.5 text-sm font-medium text-[#27AFC0] transition hover:bg-[#E0F7F9]"
                          >
                            <RotateCcw size={16} />
                            Restore
                          </button>
                          ...
                          <button
                            ...
                            className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border border-[#F3C9CE] bg-[#FFF0F2] px-3 py-2.5 text-sm font-medium text-[#B85D69] transition hover:bg-[#FFE7EA]"
                          >
                            <Trash2 size={16} />
                            Delete
                          </button>
          ...
          <AnimatePresence>
            {noteToDelete && (
              <div
                className="fixed inset-0 z-[70] flex items-center justify-center bg-[#3D3940]/35 p-4 backdrop-blur-sm"
          ...
          <AnimatePresence>
            {showDeleteAllModal && (
              <div
                className="fixed inset-0 z-[75] flex items-center justify-center bg-[#3D3940]/35 p-4 backdrop-blur-sm"
              ...
              >
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#77716B]">
                    All items in your trash will be permanently removed. This action cannot be undone.
                  </p>
